        ...
        D =
                        ...
                        e = {
                                            ...
                                            function (a) {
                                                (t.isAsync = D.isString(a)),
                                                    ...
                                                    (t.isDynamicTotalNumber =
                                                        t.isAsync &&
                                                        J.totalNumberLocator);
                                                a = t.render(!0);
                                                J.className &&
                                                    a.addClass(J.className),
                                                    (e.el = a),
                                                    c[
                                                        'bottom' === J.position
                                                            ? 'append'
                            ...
                            generatePageNumbersHTML: function (a) {
                                ...
                                if (null === J.pageRange)
                                    for (e = 1; e <= o; e++)
                                        s +=
                                            e == t
                                                ...
                                                : `<li class="${l}-page J-paginationjs-page ${c}" data-num="${e}">${i(e)}</li>`;
                                else {
                                    if (n <= 3)
                                        for (e = 1; e < n; e++)
                                            s +=
                                        ...
                                        J.hideFirstOnEllipsisShow ||
                                            (s += `<li class="${l}-page ${l}-first J-paginationjs-page ${c}" data-num="1">${i(1)}</li>`),
                                    ...
                                    if (o - 2 <= r)
                                        for (e = r + 1; e <= o; e++)
                                            s += `<li class="${l}-page J-paginationjs-page ${c}" data-num="${e}">${i(e)}</li>`;
                                    else
                                        (s += `<li class="${l}-ellipsis ${g}"><a>${a}</a></li>`),
                                            J.hideLastOnEllipsisShow ||
                                                (s += `<li class="${l}-page ${l}-last J-paginationjs-page ${c}" data-num="${o}">${i(o)}</li>`);
                                }
                                return s;
                            },
                            generateHTML: function (a) {
                                var e,
                                    ...
                                    x = '',
                                    j =
                                        '<select class="J-paginationjs-size-select">',
                                    S =
                                ...
                                if (
                                    ...
                                    (l || u || c) &&
                                        ...
                                        l &&
                                            (o <= 1
                                                ...
                                                : (x += `<li class="${y}-prev J-paginationjs-previous ${k}" data-num="${o - 1}" title="Previous page">${n(b)}</li>`)),
                                        u &&
                                            (x += t.generatePageNumbersHTML(a)),
                                        c &&
                                            (i <= o
                                                ? z ||
                                                  (x += `<li class="${y}-next ${N} ${P}"><a>${h}</a></li>`)
                                                : (x += `<li class="${y}-next J-paginationjs-next ${P}" data-num="${o + 1}" title="Next page">${n(h)}</li>`)),
                                        (x += '</ul></div>')),
                                    p && D.isArray(f))
                                ) {
                                    -1 === f.indexOf(s) &&
                                    ...
                                    for (let a = 0; a < f.length; a++)
                                        j += `<option value="${f[a]}"${f[a] === s ? ' selected' : ''}>${f[a]} / page</option>`;
                                    (e = j += '</select>'),
                                        (x += `<div class="paginationjs-size-changer">${(e = T ? t.replaceVariables(T, { length: j, total: r }) : e)}</div>`);
                                }
                                return (
                                    d &&
                                        H &&
                                        (x += `<div class="${y}-go-input">${(e = t.replaceVariables(H, { currentPage: o, totalPage: i, totalNumber: r, input: S }))}</div>`),
                                    m &&
                                        w &&
                                        (x += `<div class="${y}-go-button">${(e = t.replaceVariables(w, { currentPage: o, totalPage: i, totalNumber: r, button: v }))}</div>`),
                                    E &&
                                        (x += e =
                            ...
                            go: function (a, t) {
                                ...
                                function l(a) {
                                    ...
                                    !1 !== r.callHook('beforePaging', n) &&
                                        ...
                                        (c.data('pagination').currentPageData =
                                            a),
                                        r.doCallback(a, t),
                                        ...
                                        ? ((i =
                                          ...
                                          (a.success = function (a) {
                                              try {
                                                  ...
                                                  J.onError(
                                                      a,
                                                      'ajaxSuccessHandlerError',
                                                  );
                                              }
                                          }),
                                          (a.error = function (a, e, t) {
                                              J.formatAjaxError &&
                                                  J.formatAjaxError(a, e, t),
                                                  r.enable();
                                          }),
                                          r.disable(),
                                          J.ajaxFunction
                            ...
                            getTotalNumber: function () {
                                return (
                                    this.model.totalNumber || J.totalNumber || 0
                                );
                            },
                            getTotalPage: function () {
                                return Math.ceil(
                                    this.getTotalNumber() / J.pageSize,
                                );
                            },
                            ...
                            observer: function () {
                                var o = this,
                                    ...
                                    a =
                                        (c.on(s + 'go', function (a, e, t) {
                                            (e =
                                                ...
                                                ('number' != typeof e &&
                                                    l(
                                                        '"pageNumber" is incorrect. (Number)',
                                                    ),
                                                o.go(e, t));
                                        }),
                                        t.on(
                                    ...
                                    e = J.pageNumber;
                                o.isDynamicTotalNumber &&
                                    J.resetPageNumberOnInit &&
                                    (e = 1),
                                    J.triggerPagingOnInit &&
                                        c.trigger(s + 'go', Math.min(e, a));
                            },
                        };
                    if (
                        c.data('pagination') &&
                        !0 === c.data('pagination').initialized
                    ) {
                        if (g(a))
                            return (
                                c.trigger.call(this, s + 'go', a, arguments[1]),
                                this
                            );
                        if ('string' == typeof a) {
                            ...
                            switch (((o[0] = s + o[0]), a)) {
                                ...
                                case 'isDisabled':
                                    return (
                                        !0 ===
                                        c.data('pagination').model.disabled
                                    );
                                default:
                                    l('Unknown action: ' + a);
                            }
                        ...
                        'string' == typeof i.dataSource
                            ? void 0 === i.totalNumberLocator
                                ...
                                : 'function' != typeof i.totalNumberLocator &&
                                  l(
                                      '"totalNumberLocator" should be a Function.',
                                  )
            ...
            (u.fn.addHook = function (a, e) {
                arguments.length < 2 && l('Expect 2 arguments at least.'),
                    'function' != typeof e &&
                        l('callback should be a function.');
                var t = u(this),
                    o = t.data('pagination');
            ...
            (u[r] = function (a, e) {
                ...
                if (
                    ...
                    (t = 'string' != typeof a && a instanceof jQuery ? a : u(a))
                        .length)
                )
